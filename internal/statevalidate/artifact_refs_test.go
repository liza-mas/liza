...
func TestCollectArtifactRefsNormalizesAndSortsWithOwnerProvenance(t *testing.T) {
	...
	want := []string{
		"specs/a-output-plan.md|specs/a-output-plan.md#details|output[0].plan_ref|task-b|0",
		"specs/a-shared.md|specs/a-shared.md#task-a|spec_ref|task-a|",
		"specs/a-shared.md|specs/a-shared.md#plan|plan_ref|task-b|",
		"specs/a-shared.md|" + filepath.Join(projectRoot, "specs", "a-shared.md") + "#absolute|spec_ref|task-b|",
		"specs/a-shared.md|specs/a-shared.md#output-spec|output[0].spec_ref|task-b|0",
		"specs/a-shared.md|specs/a-shared.md#output-arch|output[1].arch_ref|task-b|1",
		"specs/b-arch.md|specs/b-arch.md|arch_ref|task-b|",
		"specs/c-epic.md|specs/c-epic.md#chapter|epic_ref|task-b|",
		"specs/d-output.md|specs/d-output.md#section|output[1].spec_ref|task-b|1",
		"specs/z-goal.md|specs/z-goal.md#intro|goal.spec_ref||",
	}
	if len(got) != len(want) {
